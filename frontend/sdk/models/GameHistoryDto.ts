 ...
 */
export function instanceOfGameHistoryDto(
  value: object,
): value is GameHistoryDto {
...
export function GameHistoryDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    total: json['total'],
    streakFreezeUsages:
      json['streakFreezeUsages'] == null
        ? undefined
        : (json['streakFreezeUsages'] as Array<any>).map(
            StreakFreezeUsageDtoFromJSON,
          ),
  };
}
...
export function GameHistoryDtoToJSONTyped(
  value?: GameHistoryDto | null,
  ...
  return {
    ...
    total: value['total'],
    streakFreezeUsages:
      value['streakFreezeUsages'] == null
        ? undefined
        : (value['streakFreezeUsages'] as Array<any>).map(
            StreakFreezeUsageDtoToJSON,
          ),
  };
}
