...
| [**specialEventControllerGetState**](ApiApi.md#specialeventcontrollergetstate) | **GET** /special-event/state | Read the current run state without mutating. |
| [**specialEventControllerGuess**](ApiApi.md#specialeventcontrollerguess) | **POST** /special-event/guess | Submit a guess for the current track in the run. |
| [**specialEventControllerNext**](ApiApi.md#specialeventcontrollernext) | **POST** /special-event/next | Advance to the next track (after the dossier has been shown). |
| [**specialEventControllerPing**](ApiApi.md#specialeventcontrollerping) | **GET** /special-event/ping | Health-check for the special-event module. Requires a trusted session. |
| [**specialEventControllerStart**](ApiApi.md#specialeventcontrollerstart) | **POST** /special-event/start | Get or create the user\&#39;s special-event run state. Idempotent — call on page load to resume. |
...
## specialEventControllerGetState

> EventStateDto specialEventControllerGetState()
...
import type { SpecialEventControllerGetStateRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.specialEventControllerGetState();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**EventStateDto**](EventStateDto.md)
...
## specialEventControllerGuess

> SpecialEventGuessResultDto specialEventControllerGuess(guessDto)
...
import type { SpecialEventControllerGuessRequest } from '';
...
async function example() {
  ...
  const body = {
    // GuessDto
    guessDto: ...,
  } satisfies SpecialEventControllerGuessRequest;

  try {
    const data = await api.specialEventControllerGuess(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**SpecialEventGuessResultDto**](SpecialEventGuessResultDto.md)
...
|-------------|-------------|------------------|
| **200** |  |  -  |
| **400** | Run is already complete. |  -  |
| **404** | No active run — call /start first. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#api-endpoints) [[Back to Model list]](../README.md#models) [[Back to README]](../README.md)


## specialEventControllerNext

> EventStateDto specialEventControllerNext()
...
import type { SpecialEventControllerNextRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.specialEventControllerNext();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|-------------|-------------|------------------|
| **200** |  |  -  |
| **400** | Current track still in progress. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#api-endpoints) [[Back to Model list]](../README.md#models) [[Back to README]](../README.md)


## specialEventControllerPing
...
import type { SpecialEventControllerPingRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.specialEventControllerPing();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Trusted session confirmed. |  -  |
| **401** | No active session. |  -  |
| **403** | Not a trusted user. |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#api-endpoints) [[Back to Model list]](../README.md#models) [[Back to README]](../README.md)


## specialEventControllerStart

> EventStateDto specialEventControllerStart()
...
import type { SpecialEventControllerStartRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.specialEventControllerStart();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
