...
export type GameStateDtoStatusEnum =
  (typeof GameStateDtoStatusEnum)[keyof typeof GameStateDtoStatusEnum];
...
export function GameStateDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    meta:
      json['meta'] == null ? undefined : MetaGameExtrasVoFromJSON(json['meta']),
  };
}
...
export function GameStateDtoToJSONTyped(
  value?: GameStateDto | null,
