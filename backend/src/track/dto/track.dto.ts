...
export class TrackDto {
  ...
  @ApiProperty({ description: "Normalized name for search/matching (no weird Unicode/spacing)" })
  ...
  @ApiPropertyOptional({ description: "The preview URL of the track", nullable: true, type: String })
  previewUrl?: string;
  ...
  @ApiPropertyOptional({ description: "Popularity score 0-100 for game balancing", type: Number })
  popularity?: number;

  @ApiProperty({ description: "Is the track explicit" })
  isExplicit: boolean;

  @ApiPropertyOptional({ description: "The release year of the track", nullable: true })
  releaseYear?: number;
}
