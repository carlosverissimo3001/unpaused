...
export function DailyStatsDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyStatsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function DailyStatsDtoToJSONTyped(value?: DailyStatsDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
